...
namespace testprincipal
{
    ...
    public class AuthenticationService : IAuthenticationService
    {
        ...
        {
            new InternalUserData("Mark", "mark@company.com", "MB5PYIsbI2YzCUe34Q5ZU2VferIoI4Ttd+ydolWV0OE=", new string[] { }),
            new InternalUserData("John", "john@company.com", "hMaLizwzOQ5LeOnMuj+C6W75Zl5CXXYbwDSHWW9ZOXc=", new string[] { "Administrators" })
        };
